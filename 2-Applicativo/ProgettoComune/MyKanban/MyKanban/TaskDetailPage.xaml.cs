...
public partial class TaskDetailPage : ContentPage
{
    ...
    //Riferimento alla pagina Kanban per poter aggiornare o eliminare la task direttamente dalla pagina di dettaglio, evitando di dover ricaricare tutte le task dopo ogni modifica
    ...
    private async void OnSaveClicked(object sender, EventArgs e)
    {
        ...
        //Aggiorna la task direttamente nella pagina Kanban senza dover ricaricare tutte le task, migliorando le prestazioni e l'esperienza utente
    ...
    private async void OnDeleteClicked(object sender, EventArgs e)
    {
        ...
        //Elimina la task direttamente nella pagina Kanban senza dover ricaricare tutte le task, migliorando le prestazioni e l'esperienza utente
